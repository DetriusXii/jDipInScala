...
import dip.gui.order2.GUIOrder;
import dip.gui.order2.GUIOrder.MapInfo;
...
public class DefaultMapRenderer2 extends MapRenderer2
{
	...
	public DefaultMapRenderer2(SVGDocument svg_doc, World world, SymbolPack sp)
	throws MapException
	{
		super(svg_doc, world);
		this.symbolPack = sp;
		...
		// get map metadata
		mapMeta = new MapMetadata(svg_doc, world, sp, true);
