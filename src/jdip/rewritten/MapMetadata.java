...
public class MapMetadata
{
	...
	private final World world;
        private final SVGDocument svg_doc;
	...
	*	
	*/
	public MapMetadata(SVGDocument svg_doc, World world, SymbolPack sp, boolean supressPlacementErrors)
	throws MapException
	{
		this.svg_doc = svg_doc;
                this.world = world;
		this.sp = sp;
		...
		Element root = svg_doc.getRootElement();
	...
	throws MapException
	{
		...
		for(int i=0; i<nl.getLength(); i++)
		{
			try
			{
				...
				Province province = world.getMap().getProvince(Coast.getProvinceName(provinceName));
				if(province == null)
				{
